...
export const tasksApi = {
  ...
  createTask: async (task: Task) => fetchJSON<Task>(endpoints.createTask.path, { method: 'POST', body: JSON.stringify(task) }),
  ...
  createProject: async (project: Project) => fetchJSON<Project>(endpoints.createProject.path, { method: 'POST', body: JSON.stringify(project) }),
};