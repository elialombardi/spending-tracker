...
interface Props {
    ...
    draftLocation?: any
    onHighlight?: (id: any) => void
    highlightedId?: any
}

export default function TagLocationsDrawer({ open, onClose, selectedTag, locations = [], onCenter, center, draftLocation, onHighlight, highlightedId }: Props) {
        ...
        <Drawer anchor="left" open={!!open} onClose={onClose}>
            <Box sx={{ width: 360, p: 1, height: '100%', display: 'flex', flexDirection: 'column' }} role="presentation">
                ...
                <Box sx={{ height: 300, mb: 1 }}>
                    <LocationMap locations={matches} center={center} onMapClick={(latlng: any) => onCenter && onCenter([latlng.lat, latlng.lng])} draftLocation={draftLocation} highlightedId={highlightedId} visible={!!open} />
                </Box>
