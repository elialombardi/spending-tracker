...
export default function NavBar({ canWrite, onLogout, session = {}, themeName, setThemeName }: NavBarProps) {
                ...
                <Box sx={{ alignItems: 'center', display: { xs: 'none', sm: 'flex' }, gap: 1.5 }}>
                    <FormControl size="small" sx={{ minWidth: 140 }}>
                        ...
                        <Select
                            ...
                            label="Theme"
                            onChange={(e) => { setThemeName?.((e.target as any).value); localStorage.setItem('theme', (e.target as any).value); }}
                        >
