...
type CreateSessionRequest struct {
	...
	CycleRestDuration    int                  `json:"CycleRestDuration" validate:"gte=0"`    // in seconds
	RoundPrepareDuration int                  `json:"roundPrepareDuration" validate:"gte=0"` // in seconds
...
type UpdateSessionRequest struct {
	...
	CycleRestDuration    *int                 `json:"CycleRestDuration" validate:"omitempty,gte=0"`
	Timers               []CreateTimerRequest `json:"timers" validate:"omitempty,min=1,dive"`
	RoundPrepareDuration *int                 `json:"roundPrepareDuration" validate:"omitempty,gte=0"` // in seconds
}
...
type SessionResponse struct {
	...
	CycleRestDuration    int             `json:"CycleRestDuration"`
	RoundPrepareDuration int             `json:"roundPrepareDuration"`
